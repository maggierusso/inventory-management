              ...
              <tr v-for="q in quarterlyData" :key="q.quarter">
                ...
                <td>
                  {{ currencySymbol
                    ...
                    q.total_revenue.toLocaleString(undefined, {
                ...
                <td>
                  {{ currencySymbol
                    ...
                    q.avg_order_value.toLocaleString(undefined, {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
                    })
                  }}
...
export default {
  ...
  setup() {
    ...
    // Bar chart: O(1) max lookup via computed
    ...
    const getChangeValue = (current, previous) => {
      ...
      const abs = Math.abs(change).toLocaleString(undefined, {
        minimumFractionDigits: 2,
        maximumFractionDigits: 2,
      });
